...
const EventPortal = () => {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:5000/api/auth/profile', { withCredentials: true })
      .then((res) => setUser(res.data || { profilePic: '' }))
    ...
    <div className="page-wrapper">
      ...
      <nav className="navbar">
        <div className="logo">
          ...
          <a href="#" onClick={navigateToDashboard}>AlumniSphere</a>
        </div>
      ...
      {/* ================= HERO SECTION ================= */}
      <section className="hero-section" style={{backgroundColor:"white", color:"black", paddingTop:"100px"}}>
        <h1 style={{backgroundColor:"white", color:"black"}}>EVENT PORTAL</h1>
      </section>
      <img
          src="/event.png"   // you can change image
          alt="Donation"
          className="banner"
      />
      ...
      <div className="job-container">
        ...
        {/* Create Event Form for Alumni */}
        {userRole === "Alumni" && (
          <div className="form-card event-form">
        ...
        <div className="form-card events-list-section">
